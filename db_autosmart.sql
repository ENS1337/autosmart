...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 26 2020 г., 03:05
...
(31, 11, 125000, 1, '2020-04-26 02:05:04', '127.0.0.1');
...
(8, 'Ford Mustang', 14530000, 'Ford', '', '', 'Рестайлинговый Мустанг получил доработанную версию атмосферного V8 объемом 5,0 литра, который теперь выдает 450 л.с. мощности вместо прежних 410 л.с. Новых показателей удалось достичь благодаря применению прямого впрыска высокого давления и распределенного впрыска низкого давления, который помогает агрегату развивать крутящий момент на невысоких оборотах. Примечательно, что для европейского рынка 2,3-литровый турбомотор после обновления стал менее мощным — 290 л.с.', 'Mustang1.jpg', '', 'Двигатель: V8<br/> Tопливо: бензин<br/> Объем: 4951 куб. см<br/> Мощность, л.с.: 450<br/> Макс скорость, км/ч: 250', '', '2020-04-08 21:43:21', 0, 0, 0, 1, 0, 'cars', 2, 1, 1),
